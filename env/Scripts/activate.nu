...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\sai\cse\projects\NTP\New_Tracker_Application\env'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\sai\cse\projects\NTP\New_Tracker_Application\env\Scripts\deactivate.nu'
